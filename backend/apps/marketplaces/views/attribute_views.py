...
Определи какой ТИП размеров принят для этой категории и оставь ТОЛЬКО подходящие.

Примеры по категориям:
- Джинси/Джинсы/Jeans → W/L размеры (W28L30, W30L32, W32L34 и т.д.) + простые числовые (28, 30, 32)
- Верхняя одежда/Куртки → UA числовые (42-56) + буквенные (XS-3XL) + EU
- Футболки/Поло → буквенные (XS, S, M, L, XL, XXL) + UA числовые
- Обувь → числовые (35-47)
- Бельё → числовые (80-100) + буквенные

Удали размеры с суффиксами -Long, -Short, -Petite, -Regular, -Tall, варианты с ростом (170 см), дубли.
Оставь 30-80 самых ходовых размеров для ЭТОЙ КОНКРЕТНОЙ категории."""
        elif is_color:
