            ...
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                    {mockProducts.map((product) => (
                        ...
                        >
                            <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-amber-50/20 to-amber-100/10 mb-8 hover:shadow-2xl transition-all duration-1000 ease-out">
                                <SimpleImage
                                    src={product.image}
                                    alt={product.name}
                                ...
                                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                    <div className="bg-white/90 backdrop-blur-sm px-3 py-1">
